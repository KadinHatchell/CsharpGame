...
namespace FirstGame.Controller
{
	...
	public class FirstGame : Game
	{
		...
		protected override void LoadContent()
		{
			...
			Texture2D playerTexture = Content.Load<Texture2D>("Animation/mj");
			playerAnimation.Initialize(playerTexture, Vector2.Zero, 40, 78, 13, 50, Color.White, 1f, true);
			...
			bgLayer1.Initialize(Content, "Background/floor", GraphicsDevice.Viewport.Width, -1);
			bgLayer2.Initialize(Content, "Background/floor", GraphicsDevice.Viewport.Width, -2);

			enemyTexture = Content.Load<Texture2D>("Animation/donkeyKongSprite");

			projectileTexture = Content.Load<Texture2D>("Animation/bullet");
			...
			mainBackground = Content.Load<Texture2D>("Background/stage");
		}
		...
		private void AddProjectile()
		{
			...
			projectile.Initialize(GraphicsDevice.Viewport, projectileTexture, player.Position);
